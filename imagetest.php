...
use const \KVSun\Consts\{DEBUG, COMPONENTS, ICONS, DEV_STYLE, DB_CREDS, DOMAIN};
...
if (! (DEBUG or user_can('debug', 'uploadMedia'))) {
	http_response_code(HTTP::UNAUTHORIZED);
	exit();
}

Console::info(['$_REQUEST' => $_REQUEST, '$_FILES' => $_FILES]);

HTML::$echoOnExit = true;
